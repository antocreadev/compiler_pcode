import { Stmt,Expr,  NumericLiteral, Identifier, BinaryExpr, VariableDeclaration, Assignment, DoWhileLoop, NativeFunctionCall  } from "./ast.ts";
interface pcode {
    op: string;
    arg: number | null;
}
type op_pcode = "ADD" | "SUB" | "MUL" | "DIV" | "EQL" | "NEQ" | "GTR" | "LSS" | "LEQ" | "GEQ" | "PRN" | "INN" | "INT" | "LDI" | "LDA" | "LDV" | "STO" | "BZE" | "HLT";
